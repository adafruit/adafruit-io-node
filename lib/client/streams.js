...
var methods = {
  load: function(cb) {
    ...
    if(this.id) {
      get = this.get('streams/' + this.id + '.json');
    } else {
      get = this.get('streams.json');
    }
  ...
  last: function(cb) {
    ...
    var get = this.get('streams/last.json');
  ...
  next: function(cb) {
    ...
    var get = this.get('streams/next.json');
  ...
  previous: function(cb) {
    ...
    var get = this.get('streams/previous.json');
  ...
  create: function(data, cb) {
    ...
    var post = this.post('streams.json', { data: data });
  ...
  send: function(data, cb) {
    ...
    var post = this.post('streams/send.json', { data: data });
  ...
  update: function(data, cb) {
    ...
    if(!this.id) {
      return cb('No stream ID supplied to update');
    }

    var patch = this.patch('streams/' + this.id + '.json', { data: data });
  ...
  delete: function(cb) {
    ...
    var del = this.del('streams/' + this.id + '.json');
